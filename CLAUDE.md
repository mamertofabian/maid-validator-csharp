...
Use the installed MAID skills for manifest-driven development: `maid-planner`, `maid-plan-review`, `maid-implementer`, `maid-implementation-review`, `maid-evolver`, `maid-auditor`, `maid-incident-logger`, `maid-outcome-enrich`, `maid-run-review`.
